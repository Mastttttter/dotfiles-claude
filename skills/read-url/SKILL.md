...
| `bilibili.com` | `bilibili_api` Python library (`uv run --with bilibili-api-python`): `sync(video.Video(bvid="BV...").get_info())` for title/description; `comment` module for comments |
