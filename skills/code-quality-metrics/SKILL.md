...
description: Measure code quality quantitatively — cyclomatic complexity, cognitive complexity, maintainability index — or when evaluating whether code meets quality thresholds.
version: 0.1.0
---
